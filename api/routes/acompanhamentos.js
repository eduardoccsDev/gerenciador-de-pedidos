...
module.exports = connection => {
    ...
    router.get('/', (req, res) => {
        connection.query('SELECT * FROM acompanhamentos ORDER BY nomeAcompanhamento', (err, rows) => {
            if (err) {
    ...
    router.post('/', (req, res) => {
        ...
        connection.query('INSERT INTO acompanhamentos SET ?', newItem, (err, result) => {
            if (err) {
    ...
    router.delete('/:id', (req, res) => {
        ...
        const query = 'DELETE FROM acompanhamentos WHERE idacompanhamento = ?';
