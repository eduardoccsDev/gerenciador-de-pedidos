...
module.exports = connection => {
    ...
    router.get('/', (req, res) => {
        connection.query('SELECT * FROM molhos ORDER BY nomeMolho ASC', (err, rows) => {
          if (err) {
    ...
    router.post('/', (req, res) => {
      ...
      connection.query('INSERT INTO molhos SET ?', newItem, (err, result) => {
          if (err) {
  ...
  router.delete('/:id', (req, res) => {
      ...
      const query = 'DELETE FROM molhos WHERE idmolho = ?';
