...
module.exports = connection => {
    ...
    router.get('/', (req, res) => {
        connection.query('SELECT * FROM bebidas ORDER BY nomeBebida ASC', (err, rows) => {
            if (err) {
    ...
    router.post('/', (req, res) => {
        ...
        connection.query('INSERT INTO bebidas SET ?', newItem, (err, result) => {
            if (err) {
    ...
    router.delete('/:id', (req, res) => {
        ...
        const query = 'DELETE FROM bebidas WHERE idbebida = ?';
