                        ...
                        <div class="cardClientInfo">
                            ...
                            <p><i class="fa-brands fa-whatsapp"></i>
                                <a :style="{ 'color': burger.corStatus }"
                                    :href="'https://api.whatsapp.com/send?phone=' + burger.telefoneCliente" target="_blank">
                    ...
                    <div class="cardsContainer">
                        <div class="card" :class="({ 'countdownFinished': burger.concluido })" v-for="burger in burgersEP"
                            ...
                            <div class="timerPreparo">
                                <button :class="({'btnDisabled': burger.concluido})" :disabled='burger.concluido' @click="iniciarContagem(burger)">
...
<style scoped>
.timerPreparo .btnDisabled{background-color:#b7b7b7!important;}#burgerTable{max-width:1200px;margin:0 auto}.reloadBtn{margin:20px auto 0;display:block;background-color:#ffb710;padding:.5em;border-radius:10px;border:none;color:#222;transition:.5s}.reloadBtn:hover{background-color:#222;color:#ffb710}.sectionEmAndamento{padding:1em;background-color:#e9e9e9;border-radius:20px}.card .tempoTitle{font-size:12px;font-weight:500;margin-bottom:0}.card.countdownFinished{border:2px solid #f76363;box-shadow:0 0 10px -2px #ff0000a1}.modal-body,.timerPreparo{text-align:left}.cardFooter{display:flex;flex-wrap:wrap;justify-content:space-between;align-content:center;margin-top:1em}.timerPreparo button{width:100%;border-radius:10px;margin-bottom:.5em;border:none;background-color:#f76363;color:#fff;padding-block:.5em}.horaPedido{background-color:#222;color:#fff;padding:.1em .4em;border-radius:5px}.msgVazio{margin:auto;background-color:#c3e7f9;padding:1em;margin-block:20px;border:2px solid #78bce6;border-radius:10px;color:#1a74aa}.card p,.cardTitle{margin-bottom:10px}.cardClientInfo,.infoCliente,select{border-radius:10px}.cardTitle{border-bottom:2px solid #00000014;display:flex;align-items:center;justify-content:space-between;padding-bottom:.5em}.card .cardTitle p{margin-bottom:0}.cardClientInfo{background-color:#f1f1f1;color:#222;padding-block:.5em}.cardClientInfo i,.infoCliente i{margin-right:10px}.cardClientInfo a{text-decoration:none;transition:.5s}.cardClientInfo a:hover{color:#222!important}.infoCliente{padding:.5em 1em;background-color:#222;color:#fff;display:flex;flex-wrap:wrap;justify-content:space-between;align-items:center}select{background-color:#fff;border:1px solid #fff;padding:.1em .5em;margin-right:.5em}.opcionaisModal{border-top:1px solid rgba(0,0,0,.062);border-bottom:1px solid rgba(0,0,0,.062);margin-block:1em;padding-top:1em}.complementosContent,.hamburgerContent{background-color:#f2f2f2;padding:.5em 1em;border-radius:10px;margin-block:20px}.titleDestaque{font-size:20px;border-bottom:2px solid rgba(0,0,0,.062);padding-bottom:.5em}.detalhes{margin-top:10px;color:#fff}.card{padding:1em;margin:.5em;width:250px;text-align:center;border-radius:20px;border:2px solid #fff;box-shadow:0 0 10px -2px #0000003b}.cardsContainer{display:flex;flex-wrap:wrap}#burgerTableHeading{font-weight:700;padding:1em;border-bottom:2px solid #333}.pontoC{display:block;font-size:16px;margin-top:2px}.btn{margin:0}.deleteBtn{background-color:#dd5454;color:#fff;border:2px solid #dd5454;padding:.2em .3em;cursor:pointer;transition:.5s;margin:0;font-size:16px;font-weight:500;height:40px;border-radius:6px}.deleteBtn:hover{background-color:#f18181;color:#fff}.infoCliente a{text-decoration:none;color:#feb610}#pills-tab{justify-content:center}</style>